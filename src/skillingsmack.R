...
percentile.05 <- c()
percentile.05 <- append(percentile.05, quantile(differences$sim.eth.dry, (0.1/6)))
percentile.05 <- append(percentile.05, quantile(differences$sim.eth.ace, (0.1/6)))
percentile.05 <- append(percentile.05, quantile(differences$sim.eth.iso, (0.1/6)))
percentile.05 <- append(percentile.05, quantile(differences$sim.ace.dry, (0.1/6)))
percentile.05 <- append(percentile.05, quantile(differences$sim.ace.dry, (0.1/6)))
percentile.05 <- append(percentile.05, quantile(differences$sim.iso.dry, (0.1/6)))

percentile.95 <- c()
percentile.95 <- append(percentile.95, quantile(differences$sim.eth.dry, 1 - (0.1/6)))
percentile.95 <- append(percentile.95, quantile(differences$sim.eth.ace, 1 - (0.1/6)))
percentile.95 <- append(percentile.95, quantile(differences$sim.eth.iso, 1 - (0.1/6)))
percentile.95 <- append(percentile.95, quantile(differences$sim.ace.dry, 1 - (0.1/6)))
percentile.95 <- append(percentile.95, quantile(differences$sim.ace.dry, 1 - (0.1/6)))
percentile.95 <- append(percentile.95, quantile(differences$sim.iso.dry, 1 - (0.1/6)))
